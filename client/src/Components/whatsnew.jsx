...
export default function WhatsNew(){
    return(
        ...
        <div className='grid1'>
            ...
            <p>
            Dream Coat's groundbreaking, lightweight, heat-activated polymer technology smooths and silkens hair, <br />
            forming an invisible matrix that acts like a water-repellent "raincoat." <br />
            It ensures sleek, glossy, glassy texture that's "immune" to frizz and lasts up to three shampoos.<br />
                </p>
                <p>SHOP NOW</p>
            </div>
        </div>
